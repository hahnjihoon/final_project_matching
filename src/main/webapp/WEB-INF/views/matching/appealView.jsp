...
<h1 style="font-family:maintitle; font-size:30px; text-align:center; cursor:pointer; " >매력평가</h1>
 <div id="slideShow"> 
 <ul class="slides"> 
 <li><img src="${ pageContext.servletContext.contextPath}/resources/idealimage/3.jpg" width:"300" height:"300" alt="" onclick = "clickImg()"><input type="hidden"></li>
 <li><img src="${ pageContext.servletContext.contextPath}/resources/idealimage/4.jpg" width:"300" height:"300" alt="" onclick = "clickImg()"></li>
 <li><img src="${ pageContext.servletContext.contextPath}/resources/idealimage/5.jpg" width:"300" height:"300" alt="" onclick = "clickImg()"></li>
 <li><img src="${ pageContext.servletContext.contextPath}/resources/idealimage/6.jpg" width:"300" height:"300" alt="" onclick = "clickImg()"></li> 
 <li><img src="${ pageContext.servletContext.contextPath}/resources/idealimage/8.jpg" width:"300" height:"300" alt="" onclick = "clickImg()"></li> 
